...
})({"gPuSQ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "fcdf9065104d3fe4";
"use strict";
...
},{}],"eNftp":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if ((0, _cartHandler.getItemCount)(item.name) > 1) {
        addItemsCart.single.classList.add("hidden");
        addItemsCart.multi.classList.remove("hidden");
        addItemsCart.count.textContent = (0, _cartHandler.getItemCount)((0, _storeItemsJsonDefault.default)[itemIDX].name);
    }
});
document.addEventListener("click", ()=>{
    addItemsCart.count.textContent = (0, _cartHandler.getItemCount)((0, _storeItemsJsonDefault.default)[itemIDX].name);
    if (Number((0, _cartHandler.getItemCount)((0, _storeItemsJsonDefault.default)[itemIDX].name) < 1)) {
...
addItemsCart.single.addEventListener("click", ()=>{
    (0, _cartHandler.incrementItemTotal)((0, _storeItemsJsonDefault.default)[itemIDX].name);
    addItemsCart.single.classList.add("hidden");
    addItemsCart.multi.classList.remove("hidden");
});
...
addItemsCart.remove.addEventListener("click", ()=>{
    (0, _cartHandler.decrementItemTotal)((0, _storeItemsJsonDefault.default)[itemIDX].name);
});

},{"../storeItems.json":"1O2RX","../handlers/cartHandler":"3gZfW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1O2RX":[function(require,module,exports) {
module.exports = JSON.parse('[{"category":"cool duck","name":"543","price":453.65,"description":"dasdasdsadasdasd","images":["/quackatician.ee280f74.jpg","img2","img3"],"length":21,"width":21,"height":21,"weight":21},{"category":"cool duck","name":"543","price":453.65,"description":"dasdasdsadasdasd","images":["/quackatician.ee280f74.jpg","img2","img3"],"length":21,"width":21,"height":21,"weight":21},{"category":"cool duck","name":"543","price":453.65,"description":"dasdasdsadasdasd","images":["/quackatician.ee280f74.jpg","img2","img3"],"length":21,"width":21,"height":21,"weight":21},{"category":"cool duck","name":"543","price":453.65,"description":"dasdasdsadasdasd","images":["/quackatician.ee280f74.jpg","img2","img3"],"length":21,"width":21,"height":21,"weight":21}]');

},{}],"3gZfW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["gPuSQ","eNftp"], "eNftp", "parcelRequiree564")
